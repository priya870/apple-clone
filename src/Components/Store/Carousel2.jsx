        ...
        {content &&
          content.map((el, i) => (
            <Box
              ...
              bgRepeat="no-repeat"
              bgPosition="center"
              // className={Styles.zoom_effect}
              transition={"0.5s all ease-in-out"}
              _hover={{transform: "scale(1.02)"}}
              bgSize="cover"
              borderRadius={"20px"}
            >
              <Text pt={"30px"} ml="40px">
                {el.text1}
              </Text>
              <Text pl="40px" mt={"8px"} fontSize="28px" fontWeight={"bold"}>
                {el.text2}
              </Text>
              <Text pl="40px" mt={"4px"} fontSize={"20px"}>
                {el.text3}
              </Text>

              <Text color="white" mt={"20px"} ml="40px">
                {el.textb1}
              </Text>
              <Text
                color="white"
              ...
              <Text color="white" ml="40px" mt={"5px"} fontSize={"20px"}>
                {el.textb3}
              </Text>
              <Text></Text>
            </Box>
