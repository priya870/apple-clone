...
const Store = () => {
  return (
    <Box className={Styles.main_box}>
      ...
      <Text fontSize={"30px"} marginLeft={"180px"} fontWeight={600}>
        The latest.{" "}
      ...
      <Text fontSize={"30px"} marginLeft={"180px"} fontWeight={600} mt="30px">
        Help is here.
        <span style={{ color: "grey" }}>
          {" "}
      ...
      <Text fontSize={"30px"} marginLeft={"180px"} fontWeight={600} mt="50px">
        Accessories.
        <span style={{ color: "grey" }}>
          {" "}
